...
class AddCommentInput(BaseModel):
    post_id: str = Field(..., description="ID do post ao qual o comentário será adicionado")
    user_id: str = Field(..., description="ID do usuário que está comentando")
    comment: str = Field(..., min_length=1, max_length=500, description="Texto do comentário")
